function StartupAssistant(changelog)
{
	...
	[
	 ...
	 { version: '1.6.1', log: [ 'Applications: Touch Surf (courtesy of petropeter), Winer (courtesy of curmudgeon69), NOVA2, Graphite, Misc OS Backup Files updated for Pre3 (in /contrib) (all courtesy of Audemars02)' ] },
